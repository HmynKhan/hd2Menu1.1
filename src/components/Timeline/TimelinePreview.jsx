...
const TimelinePreview = ({ layout, onClose, divisionsMedia = {} }) => {
  ...
  if (!token) {
    ...
    try {
      ...
      onClose(false);
          ...
          setMessage({ text: "Video saved successfully!", type: "success" });
...
{isUploading && (
  <div className="text-center">
    <p className="text-lg font-semibold">Saving video...</p>
